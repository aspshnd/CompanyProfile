...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://acerpro08.com/blog-details/acerpro",
    images: [
      {
        ...
        <div className="-mx-4 flex flex-wrap justify-center">
          <div className="w-full px-4 lg:w-8/12">
            <h2 className="mb-8 text-3xl font-bold leading-tight text-black dark:text-white sm:text-4xl sm:leading-tight">
                Portofolio Acerpro Event Organizer: Jaminan Eksekusi Acara Sempurna
            </h2>
            ...
            <div className="mb-5 w-full overflow-hidden rounded">
                ...
                <p className="mb-10 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed text-justify">
                    Tim <b>Acerpro</b> Event Organizer setelah sukses mengeksekusi salah satu acara di lapangan. 
                    Mereka adalah wajah dari komitmen kami terhadap perencanaan strategis, koordinasi lapangan, 
                    dan jaminan implementasi yang mulus dan profesional.
                </p>
